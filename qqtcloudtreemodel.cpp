...
QQTCloudTreeModel::QQTCloudTreeModel(QObject *parent, QQTFileSystem* fs) :
...
bool QQTCloudTreeModel::query(QString path)
{
    m_path = path;
...
bool QQTCloudTreeModel::removeRow(int arow, const QModelIndex &aparent)
{
    //fs
    QString prot, name;
...
QList<QStandardItem *> QQTCloudTreeModel::findItems(const QString &text, Qt::MatchFlags flags, int column) const
{
...
QList<QStandardItem *> QQTCloudTreeModel::findItems(const QModelIndex &parent, const QString &text, Qt::MatchFlags flags, int column) const
{
    QList<QStandardItem *> l;
