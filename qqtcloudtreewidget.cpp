...
QQTCloudTreeWidget::QQTCloudTreeWidget(QWidget *parent) :
    QQTTreeView(parent),
    ui(new Ui::QQTTreeWidget)
{
    ...
    m_model = new QQTCloudTreeModel(this, m_fs);
    setModel(m_model);
...
QQTCloudTreeWidget::~QQTCloudTreeWidget()
{
    delete ui;
}

void QQTCloudTreeWidget::query(QString path)
{
    QString file;
...
void QQTCloudTreeWidget::removeRow()
{
...
void QQTCloudTreeWidget::currentRowChanged()
{
    QModelIndex curIndex = currentIndex();
    QModelIndex parIndex = curIndex.parent();
...
void QQTCloudTreeWidget::clicked(QModelIndex)
{
    QModelIndex curIndex = currentIndex();
    QModelIndex parIndex = curIndex.parent();
