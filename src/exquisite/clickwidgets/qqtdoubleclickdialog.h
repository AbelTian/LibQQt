#ifndef QQTDOUBLECLICKDIALOG_H
#define QQTDOUBLECLICKDIALOG_H
 ...
 * 内置DoubleClickHelper
 *
 * 添加了doubleClick支持的QQtClickDialog
 * 这个Widget表示了如何使用QQtWidgetClickHelper和它的子类
*/
class QQTSHARED_EXPORT QQtDoubleClickDialog : public QQtVirtualClickDialog
{
    Q_OBJECT
public:
    explicit QQtDoubleClickDialog ( QWidget* parent = 0 ) :
