#ifndef QQTCUSTOMQRENCODEWIDGET_H
#define QQTCUSTOMQRENCODEWIDGET_H
...
/**
 * @brief The QQtCustomQrEncodeWidget class 二维码生成组件
 */
class QQTSHARED_EXPORT QQtCustomQrEncodeWidget : public QWidget
{
    Q_OBJECT

public:
    explicit QQtCustomQrEncodeWidget(QWidget* parent = 0);
...
#endif // QQTCUSTOMQRENCODEWIDGET_H
