...
public:
    ...
    static QQtWavAudioEffect* Instance ( QObject* parent = nullptr );

    explicit QQtWavAudioEffect ( QObject* parent = nullptr );
...
private:
    ...
    //不需要额外初始化的地方
    static QQtWavAudioEffect* msInstance;
